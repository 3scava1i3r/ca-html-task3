        ...
        {/* Color bg Image  */}
          ...
          <div className="self-stretch flex flex-col justify-start items-start py-0 px-4 gap-[16px] mt-[-48px]  lg:flex lg:flex-row lg:items-center lg:justify-between lg:mt-[-40px]">
            ...
            <div className="flex flex-row items-center justify-start gap-[12px] ">
              ...
              <button className="cursor-pointer py-2.5 px-4 bg-primary-6001 rounded-lg  overflow-hidden flex flex-row items-center justify-center gap-[8px] border-[1px] border-solid border-primary-6001 transition ease-in duration-200 hover:bg-[#6941C6]">
