        ...
        <div className="h-screen flex flex-col justify-between w-[81px] border-[1px] border-solid border-gray-300 border-t-0 border-b-0 border-l-0">
          <div className="pt-8 gap-8 flex flex-col">
            ...
            <div className="px-4 gap-2">
              <img
                ...
                src="../Images/sidebar-1.svg"
                alt=""
              />
              <img
                className="w-12 h-12 cursor-pointer"
                src="../Images/sidebar-2.svg"
                alt=""
              />
              <img
                className="w-12 h-12 cursor-pointer"
                src="../Images/sidebar-3.svg"
                alt=""
              />
              <img
                className="w-12 h-12 cursor-pointer"
              ...
              <img
                className="w-12 h-12 cursor-pointer"
                src="../Images/sidebar-5.svg"
                alt=""
              />
              <img
                className="w-12 h-12 cursor-pointer"
                src="../Images/sidebar-6.svg"
                alt=""
              />
            </div>
          </div>
          <div className="px-4 pb-6 gap-6 flex flex-col">
            ...
            <img
              ...
              <img
                className="w-12 h-12 cursor-pointer"
                src="../Images/sidebar-8.svg"
                alt=""
              />
                <img
                className="w-12 h-12 cursor-pointer"
                src="../Images/sidebar-avatar.svg"
                alt=""
              />
            </div>
          </div>
        ...
        <div className="h-screen flex-col justify-between items-start w-[281px] p-0 border-r-[1px] border-solid border-gray-200 border-t-0 border-b-0 border-l-0 md:flex">
            ...
            <div className="flex flex-col items-start pt-9 px-4 gap-4">
                ...
                <div className="flex flex-col items-start p-0 gap-1 ">
                    <SidebarTabs 
                     link="../Images/settings-1.svg"
                     text="My Details"
                    />
                    <div>
                    <div className="bg-gray-50 rounded-md">
                    <SidebarTabs 
                     link="../Images/settings-2.svg"
                     text="Profile"
                    />
                    </div>
                    ...
                    <SidebarTabs 
                     link="../Images/settings-3.svg"
                     text="Password"
                    />
                    <SidebarTabs 
                     link="../Images/settings-4.svg"
                     text="Team"
                    />
                    <SidebarTabs 
                     link="../Images/settings-5.svg"
                     text="Billing"
                    />
                    <SidebarTabs 
                     link="../Images/settings-6.svg"
                     text="Notifications"
                    />
                    <SidebarTabs 
                     link="../Images/settings-7.svg"
                     text="Integrations"
                    />
                </div>
            </div>
