const InfoForm = () => {
    return (
      <div className="self-stretch flex flex-col items-start justify-start text-left text-base text-gray-700 font-text-sm-medium1 py-0 px-4 gap-[20px] lg:flex lg:flex-row lg:mt-[-20px]">
        {/* INFO HEADING  */}
        ...
        {/* Container Form */}
        <div className="self-stretch rounded-xl bg-white overflow-hidden flex flex-col items-start justify-start text-gray-600 border-[1px] border-solid border-gray-200 lg:w-3/4">
          <form className="self-stretch bg-white flex flex-col py-5 px-4 items-start justify-start gap-[24px]">
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-[6px]">
              ...
              <div className="self-stretch rounded-lg border-[1px] border-solid border-gray-300 flex ">
                ...
                <img className="pl-3.5" src="../Images/email.svg" alt="" />
          ...
          <div className="self-stretch flex flex-col pt-0 px-0 pb-3 items-center justify-start gap-[12px]">
            ...
            <div className="self-stretch flex flex-row py-0 px-4 items-center justify-end gap-[16px]">
              <div className=" flex flex-row items-center justify-end gap-[12px]">
                ...
                <button
                  className="cursor-pointer py-2.5 px-4 bg-primary-6001 rounded-lg border-[1px] border-solid border-primary-6001 transition ease-in duration-200 hover:bg-[#6941C6]"
                >
                  <div className="font-semibold font-text-sm-medium1 text-base-white1">
                    Save changes
                  </div>
                </button>
              </div>
